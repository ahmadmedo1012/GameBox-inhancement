...
setTimeout(()=>{ try{btn.disabled=false; btn.textContent = old;}catch(e){} }, 3000);
}
});
}
...
(function(){
if (window.__gbx_mobile_header_patch) return; window.__gbx_mobile_header_patch = true;
...
if(!header) return;
if(isMobile()){
header.classList.remove('ui-hide','is-hidden');
header.style.transform = '';
header.style.top = '0';
const h = header.getBoundingClientRect().height || 60;
document.documentElement.style.setProperty('--__topbar_h', h+'px');
